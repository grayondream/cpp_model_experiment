...
#define COUT_VPTR(class_name, i, addr) cout<<"对象"#class_name"的第"<<i<<"个虚函数表地址:\t"<<setw(50)<<#class_name"::vptr"<<addr<<endl;
#define COUT_VIRTUAL_FUNC_ADDR(class_name, i, func) cout<<"对象"#class_name"的第"<<i<<"个虚函数地址:\t\t"<<(void*)func<<endl;
